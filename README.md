# AptiHub: Aptitude Test Preparation App

AptiHub is an Android application designed for users preparing for aptitude tests. It provides a platform to practice various topics, track performance, and maintain a study streak, all within a clean and intuitive user interface.
...
1.  **Clone the repository:**
    '''bash
    git clone https://github.com/harshkr045/AptiHub.git
    '''
